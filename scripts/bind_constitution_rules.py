...
BINDINGS = {
    ...
    "TRUST_MODE_MUST_BE_DECLARED": "cryptographic_trust::INVARIANT_CRYPTOGRAPHIC_TRUST_DECLARED_V0",
    "PLACEMENT_MUST_BE_DECLARED": "execution_placement::INVARIANT_EXECUTION_PLACEMENT_DECLARED_V0",
    "PLACEMENT_IMMUTABLE_AFTER_COMPILE": "execution_placement::INVARIANT_EXECUTION_PLACEMENT_DECLARED_V0",
    "REMOTE_EXECUTION_REQUIRES_CONTRACT": "execution_placement::INVARIANT_EXECUTION_PLACEMENT_DECLARED_V0",
    "SCHEDULING_MUST_BE_DECLARED": "execution_scheduling::INVARIANT_EXECUTION_SCHEDULING_DECLARED_V0",
    "PARALLEL_REQUIRES_EXPLICIT_AUTHORIZATION": "execution_scheduling::INVARIANT_EXECUTION_SCHEDULING_DECLARED_V0",
    "NON_BLOCKING_REQUIRES_EXPLICIT_AUTHORIZATION": "execution_scheduling::INVARIANT_EXECUTION_SCHEDULING_DECLARED_V0",
    "SECURITY_DOMAIN_MUST_BE_DECLARED": "security_domain::INVARIANT_SECURITY_DOMAIN_DECLARED_V0",
    "CROSS_DOMAIN_FLOW_REQUIRES_AUTHORIZATION": "security_domain::INVARIANT_SECURITY_DOMAIN_DECLARED_V0",
    # Capability surfaces: the _V0 codes these referenced were superseded by _V1.
    "CS_EXPLICIT_DECLARATION": "capability_side_effects::INVARIANT_CS_SURFACE_CLOSED_V1",
    "CS_IMPLEMENTATION_DECLARED": "execution::INVARIANT_IMPLEMENTATION_ADMISSIBLE_V0",
    "CT_IMPLEMENTATION_DECLARED": "execution::INVARIANT_IMPLEMENTATION_ADMISSIBLE_V0",
    "CT_EXPLICIT_IO": "capability_transforms::INVARIANT_CT_SURFACE_CLOSED_V1",
    "CT_PURITY": "capability_transforms::INVARIANT_ATOM_OUTPUT_PURITY_V0",
    "CT_NO_SIDE_EFFECTS": "capability_transforms::INVARIANT_ATOM_OUTPUT_PURITY_V0",
    # Actor identity: only the authority-separation rule has an enforcing invariant.
    "AC_NO_AUTHORITY_SEMANTICS": "authority::INVARIANT_ACTOR_AUTHORITY_SEPARATION_V0",
    # Invariant governance.
    "INVARIANT_MANDATORY_ENFORCEMENT": "conformance::INVARIANT_ASSERT_PARITY_V0",
